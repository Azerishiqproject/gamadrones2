      ...
      <div className="mx-auto min-h-screen max-w-[1728px]">
        <section className="relative min-h-[400px] overflow-hidden md:min-h-[500px] lg:min-h-[650px]">
          ...
          <div className="absolute left-0 top-0 z-10 flex w-full items-start justify-between p-8 md:p-10 lg:p-14">
            <div className="relative h-24 w-40 md:h-32 md:w-52 lg:h-40 lg:w-64">
              <Image
                src="/gama-logo.png"
                alt="GAMA"
                fill
        ...
        <section className="px-8 py-8 md:px-10 md:py-10 lg:px-14 lg:py-12">
          <div className="max-w-[760px]">
            <p className="text-[0.9rem] font-semibold leading-[1.2] tracking-[-0.02em] md:text-[1.2rem] lg:text-[1.4rem]">
        ...
        <section className="px-8 pb-16 md:px-10 md:pb-20 lg:px-14 lg:pb-24">
          ...
          <div className="mt-16 border-t border-black/70 pt-5 text-right md:mt-20 md:pt-6">
            <div className="text-[0.95rem] font-black uppercase tracking-[-0.02em] md:text-[1.15rem]">
              Next
            </div>
            <a
        ...
        <footer className="bg-[#1e73be] px-8 py-16 text-white md:px-10 md:py-24 lg:px-14 lg:py-32">
          <div className="max-w-[1100px]">
            <p className="max-w-[900px] text-[0.9rem] font-semibold leading-[1.2] tracking-[-0.01em] md:text-[1.1rem] lg:text-[1.4rem]">
              These guidelines were created by the The Gama Design— designers
              and writers responsible for cohesive and consistent use of our
              brand elements.
            </p>

            <p className="mt-12 text-[0.9rem] font-semibold leading-[1.2] tracking-[-0.01em] md:mt-16 md:text-[1.1rem] lg:text-[1.4rem]">
            ...
            <a
              ...
              className="mt-2 block text-[1.2rem] font-black leading-none tracking-[-0.04em] text-white hover:opacity-80 md:text-[1.6rem] lg:text-[1.8rem]"
            >
            ...
            <a
              href="#top"
              className="mt-20 inline-block text-[1rem] font-black underline decoration-2 underline-offset-4 hover:opacity-70 md:mt-28 md:text-[1.2rem] lg:text-[1.4rem]"
            >
              Back to top
            </a>
          </div>
